...
selected = option_menu('Main Menu',['Home',"UFC291",'contact','More Projects'],icons=['house','gear','envelope','book'],orientation='horizontal')
...
if selected=='Home':
   ...
   with l:
       selected_fighter_1 = str(st.selectbox('Select a Fighter for Red corner',list(set(df_red['fighter_name_Red'])),key='first',index=663))
   ...
   with r:
       ...
       selected_fighter_2 = str(st.selectbox('Select a Fighter for Blue corner',list(set(df_blue['fighter_name_Blue'])),key='second',index=1032))
